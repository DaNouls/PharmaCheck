...
const i18n = {
  es: {
    ...
    loading_compat:   'Generando informe IA…',
    v_suitable:       'Adecuado',
  ...
  en: {
    ...
    loading_compat:   'Generating AI report…',
    v_suitable:       'Suitable',
  ...
  fr: {
    ...
    loading_compat:   'Génération du rapport IA…',
  ...
  it: {
    ...
    loading_compat:   'Generazione del report IA…',
    v_suitable:       'Adatto',
  ...
  de: {
    ...
    loading_compat:   'KI-Bericht wird erstellt…',
    v_suitable:       'Geeignet',
  ...
  ca: {
    ...
    loading_compat:   'Generant informe IA…',
    v_suitable:       'Adequat',
  ...
  pt: {
    ...
    loading_compat:   'A gerar relatório IA…',
    v_suitable:       'Adequado',
  ...
  no: {
    ...
    loading_compat:   'Genererer KI-rapport…',
    v_suitable:       'Egnet',
  ...
  ro: {
    ...
    loading_compat:   'Se generează raportul IA…',
    v_suitable:       'Adecvat',
